    ...
    const handlePlaceOrder = async () => {
            ...
            if (result.isConfirmed) {
                if (validateForm()) {
                    ...
                    Swal.fire(
                        "Success!",
                        "Your order has been successfully processes!",
                        "success"
                    )
                } else {
                    Swal.fire(
        ...
        const orderData = {
            ...
            cartItems: cartItems.map(item => ({
                _type: "reference",
                _ref: item._id,  //Ensure this is correct
                _key: item._id || `cart-item-${new Date().getTime()}-${Math.random()}`,  // Generating unique _key
            })),
            total: total,
            discount: discount,
        ...
        try {
            await client.create(orderData) //moved out of Swal
            localStorage.removeItem("appliedDiscount")
        } catch (error) {
