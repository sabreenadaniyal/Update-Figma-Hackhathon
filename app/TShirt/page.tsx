...
//       image: "/product details/green tick.png",
//       reviews:
//         "I absolutely love this t-shirt! The design is unique & the fabric feels so comfortable. It's become my favorite go-to t-shirt.",
//       posting: "Posted on August 14, 2023",
//     },
//     {
//       stars: "★★★★☆",
...
//       image: "/product details/green tick.png",
//       reviews:
//         "The t-shirt exceeded my expectations! The colors are vibrant, and the print quality is top-notch. Highly recommend!",
//       posting: "Posted on August 15, 2023",
//     },
//   ];
...
//           <h1 className="text-2xl font-bold mb-2">Graphic T-Shirt</h1>
//           <div className="text-yellow-500 text-lg mb-2">★★★★☆ (4.5/5)</div>
//           <div className="flex items-center mb-4">
//             <span className="text-2xl font-bold">$260</span>
//             <span className="text-gray-500 line-through ml-4">$300</span>
//             <span className="text-red-600 bg-red-100 text-sm px-2 py-1 rounded ml-2">
//               -40%
//             </span>
//           </div>
...
//           {/* Color Selector */}
//           <div className="mb-4">
//             <h3 className="text-gray-600 text-sm mb-2">Select Color</h3>
//             <div className="flex gap-2">
//               <button className="w-8 h-8 bg-gray-700 rounded-full border"></button>
//               <button className="w-8 h-8 bg-green-700 rounded-full border"></button>
//               <button className="w-8 h-8 bg-blue-700 rounded-full border"></button>
//             </div>
//           </div>

//           {/* Size Selector */}
//           <div className="mb-4">
//             <h3 className="text-gray-600 text-sm mb-2">Select Size</h3>
//             <div className="flex gap-2">
...
//             >
//               <div className="flex items-center mb-2">
//                 <span className="text-yellow-500 text-lg">{review.stars}</span>
//                 <span className="ml-2 font-semibold">{review.title}</span>
//               </div>
//               <p className="text-gray-600 mb-2">{review.reviews}</p>
//               <p className="text-gray-400 text-sm">{review.posting}</p>
//             </div>
//           ))}
//         </div>
